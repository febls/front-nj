...
<div>
    ...
    <center>
        ...
        <v-text-field class="label-form" v-model="nome" :error-messages="emailErrors" label="Nome" required></v-text-field>
        <v-text-field class="label-form" v-model="email" :error-messages="emailErrors" label="E-mail" required></v-text-field>
        <v-text-field class="label-form" v-model="telefone" :error-messages="emailErrors" label="Telefone" required></v-text-field>
        <v-text-field class="label-form" v-model="endereco" :error-messages="emailErrors" label="Endereço" required></v-text-field>
        <v-text-field type="password" class="label-form" v-model="senha" :error-messages="emailErrors" label="Senha" required></v-text-field>
            ...
            register(e){
                ...
                .then(function (response) {
                    if(response.status == 200){
                        ...
                        alert("Email j� cadastro ao nosso sistema!");
